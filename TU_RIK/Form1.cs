    ...
    public partial class Form1 : Form
    {
        ...
        private List<gpsInfo> dataList()
        {
            ...
            while (!gpsFile.EndOfStream)
            {
                ...
                // change number values to string
                if (value1 == "1")
                {
                    value1 = "Troll";
                }
            ...
            if (dv != null)
            {
                if (selectedItem != "---Vali liik---")
                {
                    if (selectedItem == "Buss")
                    {
                        ...
                        dv.RowFilter = string.Format("Liik Like '{0}'", selectedItem); // filter table
                ...
                {
                    dataGridView1.DataSource = dt; // at first shows the whole table
            ...
            if (dv != null)
            {
                if (selectednrItem != "---Vali number---")
                {
                    ...
                    while (!rlines.EndOfStream)
                    {
                        ...
                        if (rDay == "12345z" || rDay == "12345") { rDay = "E-R"; }
                        r = rlines.ReadLine();
                        if (selectedItem == rType && selectednrItem == rNr)
                        {
